...
/////////////////////////////////////////////////////////
//  This GetFF function was taken from supplemental materials in
//  Z. Ye, et al. Phys. Lett. B 777.210 (2018), pp. 8–15.
//  - Comment from Sean Jeffas
/////////////////////////////////////////////////////////
...
void GetFitFF(const int kID, const double kQ2, double *GNGD_Fit, double* GNGD_Err){/*{{{*/
    ...
    if (kID<1 || kID>4){
        cout<<"*** ERROR***, kID is not any of [1->GEp, 2->GMp, 3->GEn, 4->GMn]"<<endl;
